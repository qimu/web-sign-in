...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsAppRoot = __webpack_require__(176);
	...
	var App = (function () {
		...
		_createClass(App, [{
			...
			value: function render(element) {
				...
				var appRootElement = _reactAddons2['default'].createElement(_componentsAppRoot2['default'], { url: '/api/signins', data: this.data, pollInterval: 2000 });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppRoot = (function (_React$Component) {
		...
		function AppRoot() {
			...
			_get(Object.getPrototypeOf(AppRoot.prototype), 'constructor', this).call(this);
			this.state = {
				data: []
			};
		}
		...
		_createClass(AppRoot, [{
			...
			value: function render() {
				return _reactAddons2['default'].createElement(
					...
					_reactAddons2['default'].createElement(_SigninForm2['default'], { onSigninSubmit: this.handleSigninSubmit.bind(this) }),
					_reactAddons2['default'].createElement(_SigninList2['default'], { data: this.state.data })
				);
			}
		}, {
			key: 'getSignins',
			value: function getSignins() {
			...
			value: function handleSigninSubmit(signin) {
				_jquery2['default'].ajax({
					url: this.props.url,
					dataType: 'json',
					type: 'POST',
	...
	AppRoot.propTypes = {
		url: _reactAddons2['default'].PropTypes.string.isRequired
	};
